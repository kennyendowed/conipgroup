            ...
            <div class="card-body">
                <form action="{{ route('product.store') }}" method="post" class="form">
                    ...
                    <div class="row gx-4 gy-3">
                        ...
                        <!-- Select -->
<div class="mb-3">
    <label for="select-input" class="form-label">Select Category</label>
    <select class="form-select @error('selectCategory') is-invalid @enderror" id="selectCategory" name="selectCategory" required>
    ...
    <span class="invalid-feedback" role="alert">
        <strong style="color:red">{{ $errors->first('selectCategory') }}</strong>
    </span>
    <br />
@endif
  </div>
